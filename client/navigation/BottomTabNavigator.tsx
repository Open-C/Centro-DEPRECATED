...
import { CeloSwapScreen } from "../screens/UbeswapScreen";
    ...
    <AppsStack.Navigator screenOptions={getScreenOptions()}>
      ...
      <AppsStack.Screen
        ...
        options={{
          headerTitle: (props) => (
            <Image
              source={require("../assets/images/moola-logo.png")}
              style={{ height: "63%" }}
            />
          ),
      ...
      <AppsStack.Screen
        name="UbeswapScreen"
        component={CeloSwapScreen}
        options={{
          headerTitle: (props) => <Text style={text.h1}>CeloSwap</Text>,
        }}
      />
      <AppsStack.Screen
  ...
  return (
    ...
    >
      <BottomTab.Screen
        ...
        options={{
          tabBarIcon: ({ color }) => (
            <FontAwesome5 size={26} name="coins" color={color} />
          ),
        }}
      />
      <BottomTab.Screen
