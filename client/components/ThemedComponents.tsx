...
export type CardProps = ViewProps & { outerStyle?: StyleProp<ViewStyle> };
export type BackgroundProps = {
  icon?: any;
  background?: LightProps;
  textOverride?: LightProps;
};
...
export function Card({
  ...
  return (
    <View style={[layout.cardWrapper, outerStyle]}>
      <View
        style={[layout.card, { backgroundColor, shadowColor }, style]}
        {...props}
      />
    </View>
  );
...
export function ButtonSmall({
  ...
  return (
    <TouchableOpacity
      style={[layout.button, layout.buttonSmall, { backgroundColor }]}
      {...props}
    >
      {icon && <Image style={layout.buttonIcon} source={icon} />}
      <Text
...
export function Slider({
  ...
  thumbImage,
  ...props
}: { tintColor: string; thumbImage: string } & ThemeProps &
  DefaultSlider["props"]) {
  ...
  return (
    <DefaultSlider
      ...
      thumbProps={
        thumbImage && {
          children: <Image source={thumbImage} style={layout.sliderThumb} />,
        }
      }
      {...props}
    />
